...
struct SearchCityView: View {
    ...
    let popularCities = ["Toronto", "New York", "Dubai", "London"]
    
    let allCities = ["Hong Kong", "Beijing", "Delhi", "Istanbul",
        ...
        Task {
            do {
                ...
                await MainActor.run {
                    isLoading = false
                    selectedCity = nil
                    alertMessage = "Could not fetch weather data. Please try again."
                    showAlert = true
                }
            }
        }
    ...
    // fetching popular cities and adding to list
        ...
        Task {
            do {
                ...
                await MainActor.run {
                    isLoading = false
                    selectedCity = nil
                    alertMessage = "Could not find weather data. Please try again."
                    showAlert = true
                }
            }
        }
